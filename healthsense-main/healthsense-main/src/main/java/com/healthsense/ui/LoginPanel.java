...
public class LoginPanel extends JPanel {
    ...
    public LoginPanel(AuthService authService, Runnable onSuccess, Runnable onBack) {
        ...
        Font inputFont = emailField.getFont().deriveFont(30f);
        ...
        JLabel title = new JLabel("Log in to HEALTHSENSE", SwingConstants.CENTER);
        ...
        submit.addActionListener(e -> doAuth());
